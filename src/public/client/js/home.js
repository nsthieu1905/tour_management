...
function startVoiceSearch() {
  ...
  document.getElementById("voiceSearch").innerHTML = '<i class="fas fa-stop text-xl"></i>';
...
function stopVoiceSearch() {
  ...
  document.getElementById("voiceSearch").innerHTML = '<i class="fas fa-microphone text-xl"></i>';
...
function showComparison() {
  ...
  const tourData = {
    sapa: { name: "Tour Sapa 3N2Đ", price: "2.890.000đ", rating: "4.8", carbon: "2.1 tấn" },
    phuquoc: { name: "Phú Quốc 4N3Đ", price: "4.590.000đ", rating: "4.9", carbon: "3.5 tấn" },
    japan: { name: "Nhật Bản 6N5Đ", price: "28.900.000đ", rating: "4.7", carbon: "8.2 tấn" },
  };
...
function showTourDetail(tourId) {
  ...
  const tourData = {
    sapa: {
      ...
      carbon: "2.1 tấn",
      timeline: [
        { day: "Ngày 1", title: "Hà Nội - Sapa", desc: "Khởi hành từ Hà Nội, di chuyển bằng xe giường nằm" },
        { day: "Ngày 2", title: "Thăm bản Cát Cát", desc: "Khám phá văn hóa dân tộc H'Mông" },
        { day: "Ngày 3", title: "Fansipan - Về Hà Nội", desc: "Chinh phục đỉnh Fansipan và trở về" },
      ],
    },
    phuquoc: {
      title: "Phú Quốc 4N3Đ",
      ...
      carbon: "3.5 tấn",
      timeline: [
        { day: "Ngày 1", title: "TP.HCM - Phú Quốc", desc: "Bay từ TP.HCM, nhận phòng resort" },
        { day: "Ngày 2", title: "Tour 4 đảo", desc: "Khám phá các đảo xung quanh Phú Quốc" },
        { day: "Ngày 3", title: "Cáp treo Hòn Thơm", desc: "Trải nghiệm cáp treo dài nhất thế giới" },
        { day: "Ngày 4", title: "Tự do - Về TP.HCM", desc: "Thời gian tự do và bay về" },
      ],
    },
    japan: {
      title: "Nhật Bản 6N5Đ",
      ...
      carbon: "8.2 tấn",
      timeline: [
        { day: "Ngày 1", title: "Hà Nội - Tokyo", desc: "Bay từ Hà Nội đến Tokyo Narita" },
        { day: "Ngày 2", title: "Tokyo City Tour", desc: "Thăm Sensoji, Shibuya, Tokyo Skytree" },
        { day: "Ngày 3", title: "Tokyo - Osaka", desc: "Di chuyển bằng tàu Shinkansen" },
        { day: "Ngày 4", title: "Osaka - Kyoto", desc: "Thăm lâu đài Osaka, đền Kiyomizu" },
        { day: "Ngày 5", title: "Kyoto - Tokyo", desc: "Thăm rừng tre Arashiyama" },
...
document.getElementById("generatePlan").addEventListener("click", function () {
  ...
  // Show loading
  button.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i>Đang tạo lịch trình...';
  ...
  setTimeout(() => {
    ...
    const selectedPrefs = Array.from(document.querySelectorAll(".preference-tag.bg-white")).map(
      (tag) => tag.dataset.pref
    );
...
function trackPriceChanges() {
  ...
  setInterval(() => {
    ...
    const priceElement = randomCard.querySelector(".text-2xl.font-bold.text-indigo-600");
...
function initDynamicPricing() {
  const priceElements = document.querySelectorAll(".text-2xl.font-bold.text-indigo-600");

  priceElements.forEach((element) => {
    element.addEventListener("mouseenter", function () {
      const tooltip = document.createElement("div");
      tooltip.className = "absolute bg-black text-white text-xs rounded py-1 px-2 z-10 -top-8 left-0";
